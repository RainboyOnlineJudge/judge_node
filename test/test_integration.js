...
function integration(){
    ...
    describe('test_normal',function(){
        it('normal.c',function(){
            var config = JSON.parse( JSON.stringify(inte_config));
            config['exe_path'] = _compile_c( join(t_path,'normal.c'));
    ...
    describe('test_math',function(){
        it('math.c',function(){
            var config = JSON.parse( JSON.stringify(inte_config));
            config['exe_path'] = _compile_c( join(t_path,'math.c'));
    ...
    describe('test_args',function(){
        it('args.c',function(){
            var config = JSON.parse( JSON.stringify(inte_config));
            config['exe_path'] = _compile_c( join(t_path,'args.c'));
